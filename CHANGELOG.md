...
- Changed [#728](https://github.com/pdepend/pdepend/pull/728): Drop unsupported Symfony versions, the supported range is now 5.4, 6, 7 and 8.
...
- Fixed [#955](https://github.com/pdepend/pdepend/pull/955): Fix parsing `self::class` constant fetch in attribute arguments.
